...
//+kubebuilder:webhook:path=/mutate-batch-shihh-cn-v1-cronjob,mutating=true,failurePolicy=fail,sideEffects=None,groups=batch.shihh.cn,resources=cronjobs,verbs=create;update,versions=v1,name=mcronjob.kb.io,admissionReviewVersions={v1,v1beta1}
